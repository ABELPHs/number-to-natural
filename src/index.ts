 ...
 * @returns {string}
 */
function english(number: number | string): string{
    return en(number);
}
 ...
 * @returns {string}
 */
function spanish(number: number | string): string{
    return sp(number);
}
/**
 ...
 * @returns {string}
 */
function englishWithDecimal(number: number | string): string{
    return enN(number);
}
/**
 ...
 * @returns {string}
 */
function spanishWithDecimal(number: number | string): string{
    return spN(number);
}
